...
* @returns {(string)[]}
*/
export function handle_is_zero(inputs) {
    try {
...
* @returns {Array<any>}
*/
export function handle_mul_with_quotient(inputs) {
...
* @returns {Array<any>}
*/
export function handle_add(inputs) {
...
* @returns {Array<any>}
*/
export function handle_neg(inputs) {
...
* @returns {Array<any>}
*/
export function handle_udiv_mod(inputs) {
...
* @returns {Array<any>}
*/
export function handle_invmod(inputs) {
...
* @returns {Array<any>}
*/
export function handle_pow(inputs) {
...
* @returns {Array<any>}
*/
export function handle_div(inputs) {
...
* @returns {Array<any>}
*/
export function handle_barrett_reduction(inputs) {
...
* @returns {Array<any>}
*/
export function handle_batch_invert(inputs) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('oracle_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
