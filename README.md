...
The actual value of a BigNum can be calculated by multiplying each limb by an increasing power of $2^{120}$. For example `[1,20,300]` represents $1*2^{120*0} + 20*2^{120*1} + 300*2^{120*2}$. We say that the BigNum is represented in radix-$2^{120}$. 
